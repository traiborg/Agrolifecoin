...
unsigned int nStakeMinAge = 60 * 60 * 2; // 7 days
...
const string strMessageMagic = "Agrolifecoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 200000000 * COIN; //premine
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Agrolifecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Agrolifecoin 2016";
        CTransaction txNew;
        txNew.nTime = 1470353840;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x3576cbd59da2f4fd3f54fbaacb451c3fc2f0b8426fb907c7f84c7c29cb55f52b"));
    ...
    string strPubKey = "04fa1fd02f04f1eb30b31359d52ef5efb449026e4fa58bc0c9388d228156952a233470c215598965d7fd94164ceee47ee4d3ac9e36ac424a76f19de2427a40e911";
...
unsigned char pchMessageStart[4] = { 0xa4, 0x22, 0xf8, 0xa6 };
